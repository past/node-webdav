var file = require("fs"),
    ...
    Directory = require("./dir").Directory,
...
FileResource.prototype.isCollection = function() {
    return this.exists() && file.statSync(this.filePath).isDirectory();
}
...
FileResource.prototype.resourceType = function() {
    if (this.isCollection()) {
		//XXX
        var doc = new libxml.Document();//"DAV:", "D:multistatus", null);
...
FileResource.prototype.MKCOL = function() {
    file.mkdirSync(this.filePath, 0666);
}
